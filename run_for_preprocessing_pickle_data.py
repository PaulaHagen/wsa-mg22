...
# Import Nature Psychological Science (only last ten years, earlier years don't have enough data)
# (For Nature Data the file is Data/nature.pkl)
print('Importing Psychological science data...')
df = pd.read_pickle('Data/psy_science.pkl')
df = df[['title', 'description', 'coverDate']]
df['coverDate'] = pd.to_datetime(df['coverDate'])
df = df.query("coverDate >= '2005-01-01'") # before this date not sufficient data
...
preprocessed_corpus = pd.read_pickle('Data/corpus.pkl')
